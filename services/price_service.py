...
class PriceService:
    ...
    def update_prices(self, force: bool = False) -> tuple[bool, str]:
        """同步更新价格
        ...
        try:
            ...
            try:
                ...
                # 设置状态
                with self._status_lock:
                    self._status = UpdateStatus.SUCCESS if success else UpdateStatus.FAILED
